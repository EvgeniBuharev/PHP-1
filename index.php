<html>
	...
	<?php 
	    ...
	    var_dump( '02' == 2); // Итог true. Строка приводится к числовому типу, числа равны
	    var_dump( '02' === 2); // Итог false.  Неравенство  из-за типа данных
	    var_dump( '02' == '2'); // Итог true. Строки приводятся к числовому типу, числа сравниваются без учёта типа
	    ?>
	<p>Задание 6.</p>
	<?php $x = true xor true; var_dump($x); // Итог true. Переменной $x присвоено значение true. Функция var_dump($x) отображает информацию о значении переменной $x ?>
    </body>		
</html>
